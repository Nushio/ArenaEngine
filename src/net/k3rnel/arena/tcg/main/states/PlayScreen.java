...
//        delta = 420;
        ...
        else if (input.isKeyDown(Input.KEY_LEFT)||input.isKeyDown(Input.KEY_A))
        {
            player = left;
            player.update(delta);
            int blocked =isBlocked((((((int)x- 10 * 0.1f)+player.getWidth()/3)+(int)camerax*-1)), (((((int)y)+60)+(int)cameray*-1))); 
            if (blocked != 0){
                float tmpx = (float)((((((int)x+ 10 * 0.1f)+player.getWidth()/2)+(int)camerax*-1))/32);
                float tmpy = (float)((((((int)y+ 10 * 0.1f)+player.getHeight())+(int)cameray*-1))/32);
                tmppx = tmpx - (int)tmpx;
...
//                }
        ...
        else if (input.isKeyDown(Input.KEY_RIGHT)||input.isKeyDown(Input.KEY_D))
        {
            player = right;
            player.update(delta);
            int blocked =isBlocked((((((int)x+ 10 * 0.1f)+40)+(int)camerax*-1)),((((int)y+60)+(int)cameray*-1) ));
            if (blocked != 0){
                float tmpx = (float)((((((int)x+ 10 * 0.1f)+player.getWidth()/2)+(int)camerax*-1))/32);
                float tmpy = (float)((((((int)y+ 10 * 0.1f)+player.getHeight())+(int)cameray*-1))/32);
                tmppx = tmpx - (int)tmpx;
